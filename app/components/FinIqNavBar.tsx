...
const NAV_LINKS: { label: string; href: string }[] = [
  { label: 'Indicadores', href: '/finiq/indicadores' },
  { label: 'Actualidad', href: '/finiq/actualidad' },
  { label: 'Aprende', href: '/finiq/aprende' },
]
      ...
      <div className="mx-auto max-w-7xl">
        <div className="flex flex-wrap items-center justify-between gap-4">
          <div className="flex items-center gap-6">
            <Link href="/finiq" className="shrink-0 text-2xl font-bold text-gray-900">
